...
Pyramid::Pyramid(Renderer& renderer, int size) {
    ...
    std::vector<Mesh::Vertex> vertices = {
        ...
        {dx::XMFLOAT3(-realSize, 0.0f, -realSize), dx::XMFLOAT3(0, -1, 0)},
        {dx::XMFLOAT3(realSize, 0.0f, -realSize), dx::XMFLOAT3(0, -1, 0)},
        {dx::XMFLOAT3(-realSize, 0.0f, realSize), dx::XMFLOAT3(0, -1, 0)},
        ...
        // Face avant
        {dx::XMFLOAT3(-realSize, 0.0f, -realSize), dx::XMFLOAT3(0, angle, -angle)},
        {dx::XMFLOAT3(realSize, 0.0f, -realSize), dx::XMFLOAT3(0, angle, -angle)},
        {dx::XMFLOAT3(0.0f, size, 0.0f), dx::XMFLOAT3(0, angle, -angle)},

        // Face droite
        {dx::XMFLOAT3(realSize, 0.0f, -realSize), dx::XMFLOAT3(angle, angle, 0)},
        {dx::XMFLOAT3(realSize, 0.0f, realSize), dx::XMFLOAT3(angle, angle, 0)},
